...
public class Drink extends Stuff implements Serializable{
	public Drink() {}
	...
	public void buy() {
		...
		while(true) {
			try {
				...
				System.out.print(drinks[cusorder[j]-1].getName() + " ");	
				}
				...
				if (intention.equals("y")) {
					...
					System.out.println("숫자를 입력해주세요. 첫 화면으로 돌아갑니다");
					break;
				}
